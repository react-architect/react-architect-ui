...
export const TopWaveBackground = withTheme(function (props: IWaveBackgroundProps) {
  return (
    <WaveFrame>
      <Wave viewBox="0 0 500 65" preserveAspectRatio="xMinYMin meet">
        ...
        <path
          d="m0,60 C150,70 350,30 500,40 L500,00 L0,0 Z"
          fill={props.theme.altDarkColor}
        ></path>
        <path
          d="m0,60 C150,70 350,20 500,30 L500,00 L0,0 Z"
          fill="url(#linear)"
        ></path>
      </Wave>
      {props.children}
