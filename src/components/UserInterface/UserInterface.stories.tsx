...
storiesOf('UserInterface', module)
    ...
    .add('A basic UI', () => {
        ...
        const story = <UserInterface theme={contentTheme}><Content>{content}</Content></UserInterface>;
    ...
    .add('A fullscreen UI', () => {
        ...
        const story = <UserInterface fullscreen theme={contentTheme}><Content ref={self => {contentDiv = self}}>{content}</Content></UserInterface>;

        specs(() => describe('render content in fullscreen', function () {
